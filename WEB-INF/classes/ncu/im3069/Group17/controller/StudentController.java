...
import ncu.im3069.Group17.app.Student;
...
public class StudentController extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        /** 建立一個新的學生物件 */
        Student s = new Student(email, password, name, sex);
        ...
        /** 透過StudentHelper物件的checkDuplicate()檢查該學生電子郵件信箱是否有重複 */
        else if (!sh.checkDuplicate(s)) {
