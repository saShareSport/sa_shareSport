...
public class StudentHelper {
    ...
    public JSONObject getLogin(String email, String password) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_sharesport`.`students` WHERE `email` = ?  and `password` = ? LIMIT 1";
    ...
    public int checkLogin(String email, String password){
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT count(*) FROM `sa_sharesport`.`students` WHERE `email` = ?  and `password` = ? LIMIT 1";
